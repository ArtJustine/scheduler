    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr,400px] gap-6">
        ...
        <div className="relative">
          <Button
            variant={isPlatformSelected("tiktok") ? "default" : "outline"}
            size="icon"
            className={cn(
              "rounded-full h-12 w-12 transition-all",
              isPlatformSelected("tiktok") && "ring-2 ring-primary ring-offset-2 ring-offset-background"
            )}
        ...
        <div className="relative">
          <Button
            variant={isPlatformSelected("youtube") ? "default" : "outline"}
            size="icon"
            className={cn(
              "rounded-full h-12 w-12 transition-all",
              isPlatformSelected("youtube") && "ring-2 ring-primary ring-offset-2 ring-offset-background"
            )}
