    ...
    <div className="flex min-h-screen flex-col bg-background text-foreground font-sans">
      ...
      <section className="relative w-full min-h-[85vh] flex items-center justify-center overflow-hidden bg-white dark:bg-black transition-colors duration-500">
        ...
        <div className="absolute inset-0 pointer-events-none hidden md:block">
          <FloatingIcon initialPos={{ top: "15%", left: "10%" }} className="animate-float-slow animate-bounce-subtle-delay-1">
          ...
          <FloatingIcon initialPos={{ bottom: "8%", right: "22%" }} className="animate-float-medium animate-bounce-subtle-slow">
            <div className="w-20 h-20 bg-white rounded-full shadow-[0_20px_50px_rgba(0,0,0,0.1)] flex items-center justify-center border border-gray-100 group hover:scale-110 transition-transform duration-500">
        ...
        <div className="absolute inset-0 pointer-events-none md:hidden opacity-[0.15] dark:opacity-[0.25] overflow-hidden">
          <FloatingIcon initialPos={{ top: "10%", left: "10%" }} className="animate-float-slow animate-bounce-subtle-delay-3">
          ...
          <FloatingIcon initialPos={{ top: "15%", left: "70%" }} className="animate-float-fast animate-bounce-subtle-delay-1">
          ...
          <FloatingIcon initialPos={{ top: "60%", left: "15%" }} className="animate-float-medium animate-bounce-subtle-delay-4">
          ...
          <FloatingIcon initialPos={{ top: "80%", left: "70%" }} className="animate-float-slow animate-bounce-subtle-delay-2">
            <div className="bg-white p-2 rounded-full shadow-lg border border-gray-100 flex items-center justify-center w-16 h-16">
        ...
        <div className="container relative z-10 px-6 pt-24 md:pt-32 pb-12">
          <div className="max-w-5xl mx-auto text-center space-y-8 md:space-y-10">
            ...
            <div className="flex justify-center pt-4 md:pt-6 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-300">
              <Link href="/waitlist">
                <Button size="lg" className="rounded-full bg-primary text-primary-foreground text-sm md:text-base px-8 h-12 font-bold tracking-tight transition-all hover:scale-105 active:scale-95 border-0">
                  Try Chiyu for free
                </Button>
              </Link>
            </div>
