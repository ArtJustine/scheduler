...
function AnalyticsContent() {
    ...
    const calculateRealStats = (accounts: any, platform: string) => {
        ...
        } else if (accounts && accounts[platform]) {
    ...
    const realStats = calculateRealStats(accounts, selectedPlatform)
            ...
            {isLoading ? (
                ...
                <>
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                        {[
                            { label: "Total Views", value: realStats.views, icon: Eye },
                            { label: "Subscribers", value: realStats.followers, icon: Users },
                            { label: "Total Likes", value: realStats.likes, icon: Heart },
                            { label: "Total Posts", value: realStats.posts, icon: BarChart3 },
                        ].map((stat, i) => (
