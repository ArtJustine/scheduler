  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md w-14 font-semibold text-[0.85rem] uppercase tracking-wider",
        ...
        day: cn(
          ...
          "h-14 w-14 p-0 font-normal aria-selected:opacity-100 transition-all hover:bg-primary/10 hover:text-primary rounded-xl"
        ),
        ...
        day_today: "border-2 border-primary/50 text-foreground font-bold bg-primary/5",
        day_outside:
